...
<div class="x_x_x_x_x_x_x_x_x_x_x_x_x_x_x_x_x_x_x_x_x_x_x_x_x_x_x_x_x_x_x_x_x_x_x_x_x_x_x_x_x_x_x_x_x_x_x_x_x_x_x_x_x_x_keyboardFocusClass"><span style="font-size:10pt">Tā kā ]]><![CDATA[{!ParticipationFrom;}]]><![CDATA[ esi kļuvis par mūsu atbalstītāju, mēs priecāsimies par Tavām idejām un Tavu līdzdalību, jo mērķis - ērtāka, drošāka un patīkamāka pilsēta - ir sasniedzams!</span></div>
