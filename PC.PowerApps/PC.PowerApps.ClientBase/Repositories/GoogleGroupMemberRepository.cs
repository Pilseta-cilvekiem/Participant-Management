    ...
    public static class GoogleGroupMemberRepository
    {
        public static async Task SynchronizeSupporters(Context context)
        {
            ...
            List<Contact> activeSupporters = context.ServiceContext.ContactSet
                .Where(c => c.pc_ParticipationLevel == pc_ParticipationLevel.Supporter && c.pc_WishesToBeActive == true && c.pc_PaidParticipationFee.Value >= 2 && c.EMailAddress1 != null && c.EMailAddress1 != string.Empty)
