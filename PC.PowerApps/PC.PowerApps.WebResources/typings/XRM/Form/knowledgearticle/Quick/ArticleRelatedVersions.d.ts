declare namespace Form.knowledgearticle.Quick {
  namespace ArticleRelatedVersions {
    namespace Tabs {
      interface general extends Xrm.SectionCollectionBase {
        get(name: "Versions"): Xrm.PageSection;
    ...
    interface Controls extends Xrm.ControlCollectionBase {
      get(name: "RelatedVersionsGrid"): Xrm.SubGridControl<"knowledgearticle">;
  ...
  interface ArticleRelatedVersions extends Xrm.PageBase<ArticleRelatedVersions.Attributes,ArticleRelatedVersions.Tabs,ArticleRelatedVersions.Controls> {
    ...
    getControl(controlName: "RelatedVersionsGrid"): Xrm.SubGridControl<"knowledgearticle">;
