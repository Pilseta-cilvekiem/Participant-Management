declare namespace Form.knowledgearticle.Quick {
  namespace ArticleContent {
    namespace Tabs {
      interface general extends Xrm.SectionCollectionBase {
        get(name: "ArticleContent"): Xrm.PageSection;
    ...
    interface Attributes extends Xrm.AttributeCollectionBase {
      ...
      get(name: "knowledgearticleid"): Xrm.Attribute<string>;
    ...
    interface Controls extends Xrm.ControlCollectionBase {
      get(name: "KnowledgeArticleContent"): Xrm.StringControl;
      get(name: "KnowledgeArticleId"): Xrm.StringControl;
      get(name: "KnowledgeArticleState"): Xrm.OptionSetControl<knowledgearticle_statuscode>;
      get(name: "KnowledgeArticleTitle"): Xrm.StringControl;
  ...
  interface ArticleContent extends Xrm.PageBase<ArticleContent.Attributes,ArticleContent.Tabs,ArticleContent.Controls> {
    ...
    getAttribute(attributeName: "knowledgearticleid"): Xrm.Attribute<string>;
    ...
    getControl(controlName: "KnowledgeArticleContent"): Xrm.StringControl;
    getControl(controlName: "KnowledgeArticleId"): Xrm.StringControl;
    getControl(controlName: "KnowledgeArticleState"): Xrm.OptionSetControl<knowledgearticle_statuscode>;
    getControl(controlName: "KnowledgeArticleTitle"): Xrm.StringControl;
