declare namespace Form.slakpiinstance.Main {
  namespace SLAKPIInstance {
    ...
    interface Attributes extends Xrm.AttributeCollectionBase {
      ...
      get(name: "regarding"): Xrm.LookupAttribute<"account" | "activitypointer" | "appointment" | "contact" | "email" | "fax" | "letter" | "phonecall" | "socialactivity" | "task">;
    ...
    interface Controls extends Xrm.ControlCollectionBase {
      ...
      get(name: "regarding"): Xrm.LookupControl<"account" | "activitypointer" | "appointment" | "contact" | "email" | "fax" | "letter" | "phonecall" | "socialactivity" | "task">;
  ...
  interface SLAKPIInstance extends Xrm.PageBase<SLAKPIInstance.Attributes,SLAKPIInstance.Tabs,SLAKPIInstance.Controls> {
    ...
    getAttribute(attributeName: "regarding"): Xrm.LookupAttribute<"account" | "activitypointer" | "appointment" | "contact" | "email" | "fax" | "letter" | "phonecall" | "socialactivity" | "task">;
    ...
    getControl(controlName: "regarding"): Xrm.LookupControl<"account" | "activitypointer" | "appointment" | "contact" | "email" | "fax" | "letter" | "phonecall" | "socialactivity" | "task">;
