interface Email_Base extends WebEntity {
  ...
  pc_category?: pc_emailcategory | null;
...
interface Email_Select {
  ...
  pc_category: WebAttribute<Email_Select, { pc_category: pc_emailcategory | null }, { pc_category_formatted?: string }>;
