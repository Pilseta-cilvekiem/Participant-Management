...
interface Queue_Relationships {
  ...
  pc_Settings_EmailSender_Queue?: pc_Settings_Result[] | null;
...
interface Queue_Expand {
  ...
  pc_Settings_EmailSender_Queue: WebExpand<Queue_Expand, pc_Settings_Select, pc_Settings_Filter, { pc_Settings_EmailSender_Queue: pc_Settings_Result[] }>;
...
interface Queue_RelatedMany {
  ...
  pc_Settings_EmailSender_Queue: WebMappingRetrieve<pc_Settings_Select,pc_Settings_Expand,pc_Settings_Filter,pc_Settings_Fixed,pc_Settings_Result,pc_Settings_FormattedResult>;
